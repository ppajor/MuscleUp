...
import {Text, TouchableHighlight,TouchableOpacity,Image, StyleSheet, View} from "react-native";
  ...
  const handleSignOut = () => {
    ...
    return (
      ...
      <View style={styles.lastTraining}>
        <Text>Ostatni trening</Text>
      </View>
      <View style={styles.trainingContainer}>
        <TouchableOpacity style={styles.treningStart}
        onPress={()=> props.history.push("/StartTraining")}>
          <Image style={styles.icon} source={require("../../assets/playBtn.png")} />
          <Text style={styles.trainingStartText}>Rozpocznij trening</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.treningStart,styles.trainingPlan]}
        onPress={()=> props.history.push("/ChoosePlan")}>
        <Image style={styles.icon} source={require("../../assets/planIcon.png")} />
        <Text>Wybierz plan</Text>
        </TouchableOpacity>
        <TouchableOpacity 
        style={[styles.treningStart,styles.trainingPlan]}
        onPress={()=> props.history.push("/AddPlan")}>
        <Image style={styles.icon} source={require("../../assets/add2Icon.png")} />
